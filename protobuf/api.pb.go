...
func _PublishRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *PublishRequest_SystemContext:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.SystemContext); err != nil {
			return err
		}
	case *PublishRequest_TenantContext:
	...
	case nil:
	default:
		return fmt.Errorf("PublishRequest.Context has unexpected type %T", x)
	}
	return nil
}
...
func _PublishRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*PublishRequest)
	switch tag {
	case 4: // context.system_context
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(SystemContext)
		err := b.DecodeMessage(msg)
		m.Context = &PublishRequest_SystemContext{msg}
		return true, err
	case 5: // context.tenant_context
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TenantContext)
		err := b.DecodeMessage(msg)
		m.Context = &PublishRequest_TenantContext{msg}
		return true, err
	default:
		return false, nil
	}
...
func _SubscribeResponse_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	// context
	switch x := m.Context.(type) {
	case *SubscribeResponse_SystemContext:
		b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.SystemContext); err != nil {
			return err
		}
	case *SubscribeResponse_TenantContext:
	...
	case nil:
	default:
		return fmt.Errorf("SubscribeResponse.Context has unexpected type %T", x)
	}
	return nil
}
...
func _SubscribeResponse_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*SubscribeResponse)
	switch tag {
	case 5: // context.system_context
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(SystemContext)
		err := b.DecodeMessage(msg)
		m.Context = &SubscribeResponse_SystemContext{msg}
		return true, err
	case 6: // context.tenant_context
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TenantContext)
		err := b.DecodeMessage(msg)
		m.Context = &SubscribeResponse_TenantContext{msg}
		return true, err
	default:
		return false, nil
	}
